    ...
    d) ls -l --time-style=+ /proc/self/fd/ 0</tmp/toto 2>/tmp/toto 3<>/tmp/toto 4</tmp/tata 5>/tmp/toto`}</code></pre></p>
        ...
        <ul className="question-list">
          <li>
            ...
            <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/prodcons.sh" download target="_blank" rel="noopener noreferrer">prodcons.sh</a> </p>
              <br/>
            ...
            <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/prodcons2.sh" download target="_blank" rel="noopener noreferrer">prodcons2.sh</a></p>
              <br/>
        ...
        <ul className="question-list">
            <li>
                ...
                <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/ecrivain.sh" download target="_blank" rel="noopener noreferrer">ecrivain.sh</a></p>
                <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/lecteur.sh" download target="_blank" rel="noopener noreferrer">lecteur.sh</a></p>
                <br/>
                ...
                <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/ecrivain2.sh" download target="_blank" rel="noopener noreferrer">ecrivain2.sh</a></p>
                <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/lecteur2.sh" download target="_blank" rel="noopener noreferrer">lecteur2.sh</a></p>
                <br/>
                ...
                <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/lecteur-ecrivain.sh" download target="_blank" rel="noopener noreferrer">lecteur-ecrivain.sh</a></p>
                <br/>
                ...
                <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/lecteur3.sh" download target="_blank" rel="noopener noreferrer">lecteur3.sh</a></p>
                <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/ecrivain3.sh" download target="_blank" rel="noopener noreferrer">ecrivain3.sh</a></p>
                <br/>
                ...
                <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/lecteur-ecrivain2.sh" download target="_blank" rel="noopener noreferrer">lecteur-ecrivain2.sh</a></p>
            ...
            <ul className="question-list">
                <li>
                    ...
                    <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/ilestquelleheure.sh" download target="_blank" rel="noopener noreferrer">ilestquelleheure.sh</a></p>
                    <br/>
                    ...
                    <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/ilestquelleheure2.sh" download target="_blank" rel="noopener noreferrer">ilestquelleheure2.sh</a></p>
                    ...
                    <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/ilestquelleheure3.sh" download target="_blank" rel="noopener noreferrer">ilestquelleheure3.sh</a></p>
                    ...
                    <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/ilestquelleheure4.sh" download target="_blank" rel="noopener noreferrer">ilestquelleheure4.sh</a></p>
                    ...
                    <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/ilestquelleheure5.sh" download target="_blank" rel="noopener noreferrer">ilestquelleheure5.sh</a></p>
        ...
        <div id="Exercice5" className="mt-5 pt-5">
          ...
          <ul className="question-list">
              <li>
                  ...
                  <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/interpreter.sh" download target="_blank" rel="noopener noreferrer">interpreter.sh</a></p>
                  ...
                  <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/interpreter2.sh" download target="_blank" rel="noopener noreferrer">interpreter2.sh</a></p>
                  <br/>
                  ...
                  <p className="answer-highlight">Réponse : Voir script <a href="https://raw.githubusercontent.com/MalikSploit/tp3_se/main/src/Scripts/interpreter3.sh" download target="_blank" rel="noopener noreferrer">interpreter3.sh</a></p>
